...
urlpatterns = [
    ...
    # 배달 댓글 조회, 생성
    path('deliveries/<int:id>/comments/', DeliveryCommentView.as_view, name='delivery-comments-list'),
    # 배달 댓글 삭제, 수정
    path('deliveries/<int:id>/comments/', DeliveryCommentDetailView.as_view, name='delivery-comments-list'),
